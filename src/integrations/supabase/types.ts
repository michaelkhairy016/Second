...
export type Database = {
  public: {
    Tables: {
      ...
      factory_calendar: {
        Row: { created_at: string; date: string; id: string; is_working_day: boolean; notes: string | null }
        Insert: { created_at?: string; date: string; id?: string; is_working_day?: boolean; notes?: string | null }
        Update: { created_at?: string; date?: string; id?: string; is_working_day?: boolean; notes?: string | null }
        Relationships: []
      }
      factory_snapshots: {
      ...
      job_orders: {
        Row: { color_plan: Json | null; created_at: string; id: string; job_code: string; lot_id: string; model_year: string | null; status: Database["public"]["Enums"]["lot_status"]; units: number; vin_sequence: string[] | null }
        Insert: { color_plan?: Json | null; created_at?: string; id?: string; job_code: string; lot_id: string; model_year?: string | null; status?: Database["public"]["Enums"]["lot_status"]; units: number; vin_sequence?: string[] | null }
        Update: { color_plan?: Json | null; created_at?: string; id?: string; job_code?: string; lot_id?: string; model_year?: string | null; status?: Database["public"]["Enums"]["lot_status"]; units?: number; vin_sequence?: string[] | null }
      ...
      lots: {
        Row: { chinese_number: string | null; created_at: string; created_by: string | null; id: string; lot_code: string; model: string; status: Database["public"]["Enums"]["lot_status"]; total_units: number }
        Insert: { chinese_number?: string | null; created_at?: string; created_by?: string | null; id?: string; lot_code: string; model: string; status?: Database["public"]["Enums"]["lot_status"]; total_units: number }
        Update: { chinese_number?: string | null; created_at?: string; created_by?: string | null; id?: string; lot_code?: string; model?: string; status?: Database["public"]["Enums"]["lot_status"]; total_units?: number }
        Relationships: []
      }
      model_trims: {
      ...
      shortages: {
        Row: { cleared_at: string | null; cleared_by: string | null; created_at: string; created_by: string | null; id: string; notes: string | null; part_type: string | null; parts: string[]; received_by: string | null; released_by: string | null; responsibility: string | null; status: Database["public"]["Enums"]["shortage_status"]; vehicle_id: string }
        Insert: { cleared_at?: string | null; cleared_by?: string | null; created_at?: string; created_by?: string | null; id?: string; notes?: string | null; part_type?: string | null; parts: string[]; received_by?: string | null; released_by?: string | null; responsibility?: string | null; status?: Database["public"]["Enums"]["shortage_status"]; vehicle_id: string }
        Update: { cleared_at?: string | null; cleared_by?: string | null; created_at?: string; created_by?: string | null; id?: string; notes?: string | null; part_type?: string | null; parts?: string[]; received_by?: string | null; released_by?: string | null; responsibility?: string | null; status?: Database["public"]["Enums"]["shortage_status"]; vehicle_id: string }
      ...
      vehicles: {
        Row: { actual_color_id: string | null; created_at: string; current_station: Database["public"]["Enums"]["station_code"] | null; id: string; is_lot_tail: boolean; job_order_id: string | null; lot_id: string | null; planned_color_id: string | null; tail_note: string | null; updated_at: string; vin: string; vin_suffix: string }
        Insert: { actual_color_id?: string | null; created_at?: string; current_station?: Database["public"]["Enums"]["station_code"] | null; id?: string; is_lot_tail?: boolean; job_order_id?: string | null; lot_id?: string | null; planned_color_id?: string | null; tail_note?: string | null; updated_at?: string; vin: string; vin_suffix: string }
        Update: { actual_color_id?: string | null; created_at?: string; current_station?: Database["public"]["Enums"]["station_code"] | null; id?: string; is_lot_tail?: boolean; job_order_id?: string | null; lot_id?: string | null; planned_color_id?: string | null; tail_note?: string | null; updated_at?: string; vin?: string; vin_suffix?: string }
    ...
    Functions: {
      get_delayed_vehicles: { Args: { threshold_days?: number }; Returns: { current_station: string; entered_at: string; job_order_id: string; lot_code: string; lot_model: string; vehicle_id: string; vin: string; vin_suffix: string; working_days_at_station: number }[] }
    ...
    Enums: {
      ...
      station_code: "warehouse" | "body_shop" | "wbs" | "paint" | "pbs" | "shortage" | "repair" | "cs" | "pdi"
    }
