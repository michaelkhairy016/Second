  ...
  public: {
    Tables: {
      ...
      job_order_lots: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_order_lots_job_order_id_fkey"
            columns: ["job_order_id"]
            isOneToOne: false
            referencedRelation: "job_orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "job_order_lots_lot_id_fkey"
            columns: ["lot_id"]
            isOneToOne: false
            referencedRelation: "lots"
            referencedColumns: ["id"]
      ...
      production_plans: {
        ...
        Relationships: [
          {
            foreignKeyName: "production_plans_model_id_fkey"
            columns: ["model_id"]
            isOneToOne: false
            referencedRelation: "models"
            referencedColumns: ["id"]
      ...
      vehicle_restrictions: {
        Row: {
          ...
          restriction: string
          status: string
          stop_at_station: Database["public"]["Enums"]["station_code"]
          vehicle_id: string
        }
        Insert: {
          cleared_at?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "vehicle_restrictions_job_order_id_fkey"
            columns: ["job_order_id"]
            isOneToOne: false
            referencedRelation: "job_orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vehicle_restrictions_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
            referencedRelation: "vehicles"
            referencedColumns: ["id"]
