...
export type Database = {
  public: {
    Tables: {
      ...
      job_orders: {
        Row: { color_plan: Json | null; contract_company: string | null; created_at: string; id: string; is_contract: boolean; job_code: string; lot_id: string | null; model_year: string | null; status: Database["public"]["Enums"]["lot_status"]; units: number; vin_sequence: string[] | null }
        Insert: { color_plan?: Json | null; contract_company?: string | null; created_at?: string; id?: string; is_contract?: boolean; job_code: string; lot_id?: string | null; model_year?: string | null; status?: Database["public"]["Enums"]["lot_status"]; units: number; vin_sequence?: string[] | null }
        Update: { color_plan?: Json | null; contract_company?: string | null; created_at?: string; id?: string; is_contract?: boolean; job_code?: string; lot_id?: string | null; model_year?: string | null; status?: Database["public"]["Enums"]["lot_status"]; units?: number; vin_sequence?: string[] | null }
    ...
    Enums: {
      ...
      station_code: "warehouse" | "body_shop" | "wbs" | "paint" | "pbs" | "shortage" | "repair" | "cs" | "pdi" | "tcf" | "waiting_repair" | "tcf_offline"
    }
