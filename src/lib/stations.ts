import { Boxes, Frame, PaintBucket, ParkingSquare, AlertTriangle, Wrench, ClipboardCheck, Truck, Cog, Link2 } from "lucide-react";
...
export const STATIONS: StationDef[] = [
  ...
  { code: "line_feeding", label: "Line Feeding", short: "LF", description: "Released vehicles", icon: Link2, module: "bulk" },
